...
namespace Marika::UI {
	...
	void DrawButtonImage(const std::shared_ptr<Marika::Image> &imageNormal, const std::shared_ptr<Marika::Image> &imageHovered, const std::shared_ptr<Marika::Image> &imagePressed,
	...
	void DrawButtonImage(const std::shared_ptr<Marika::Image> &image,
	                     ImU32 tintNormal, ImU32 tintHovered, ImU32 tintPressed,
	                     ImVec2 rectMin, ImVec2 rectMax) {
